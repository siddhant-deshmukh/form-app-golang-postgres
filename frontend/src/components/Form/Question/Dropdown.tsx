    ...
    <div className='relative w-fit h-fit'>
      ...
      >
        <ul
          ...
          <li className='w-full'>
            <button
              onClick={(event) => { event.preventDefault(); changeRes(queKey, [], 'dropdown'); setToggle(false) }}
            ...
            question.options.map((str,index) => {
              return (
                <li className='w-full' key={index}>
                  <button
                    onClick={(event) => { event.preventDefault(); changeRes(queKey, [str], 'dropdown'); setToggle(false) }}
