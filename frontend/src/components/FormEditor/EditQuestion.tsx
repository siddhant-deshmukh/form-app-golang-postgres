...
import NotInFocusQue from './question/NotInFocusQue'
import { DndTrigger } from '../../types/sortable-hoc'
import { changeSelectedQue } from '../../features/queState'
import { InFocusQuestion } from './question/InFocusQuestion'
...
const QuestionFormElement = ({ queKey, question, isSelected, selectQuestionRef }: {
  ...
  function handleQuesClick(event: React.MouseEvent<HTMLDivElement, MouseEvent>) {
    ...
    dispatch(changeSelectedQue(queKey))
    // console.log(event)
  ...
  return (
    ...
    >
     ...
     
      {
        ...
        <NotInFocusQue isSelected={isSelected} queKey={queKey} question={question} />
      } 
    </div>
  )
}
